...
const MESSAGES = {
  en: {
    ...
    "history.scope": "This till only, since midnight. Other tills are corrected on their own device, or in the back office.",
    ...
    "history.refundCash": "Give {total} back from the drawer.",
    "history.refundCard": "Refund the customer on the card terminal — the till cannot do it for you.",
    "history.reuse": "Put the items back in the basket",
  ...
  fr: {
    ...
    "history.scope": "Cette caisse uniquement, depuis minuit. Les autres se corrigent sur leur propre appareil, ou en back-office.",
    ...
    "history.refundCash": "Rendez {total} sur la caisse.",
    "history.refundCard": "Remboursez le client sur le TPE — la caisse ne peut pas le faire à votre place.",
    "history.reuse": "Remettre les articles au panier",
