...
const MESSAGES = {
  en: {
    ...
    "history.title": "Today on this till",
    "history.loading": "Loading…",
    "history.empty": "Nothing recorded on this till today.",
  ...
  fr: {
    ...
    "history.title": "Aujourd’hui sur cette caisse",
    "history.loading": "Chargement…",
    "history.empty": "Rien d’enregistré sur cette caisse aujourd’hui.",
