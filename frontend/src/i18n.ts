...
export const MESSAGES = {
  en: {
    ...
    "drawer.countHelp":
      "Count what is in the drawer. The till only says what it expected once your count is recorded.",
  ...
  fr: {
    ...
    "drawer.countHelp":
      "Comptez ce qu’il y a dans la caisse. Le montant attendu ne s’affiche qu’une fois votre comptage enregistré.",
