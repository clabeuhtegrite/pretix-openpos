...
const SCENES = [
  ...
  {
    name: "lecteur, annulation",
    q: "role=pos&card=terminal",
    steps: [{ text: "Bière pression 25cl" }, { text: "Encaisser" }, { text: "Carte" }, { wait: 2500 }, { text: "Annuler le paiement" }, { wait: 600 }],
  },
  // ?slow=1 : ce que l'écran montre pendant que le serveur répond.
  { name: "réessai", q: "role=pos&load=refused&slow=1", steps: [{ wait: 6000 }, { text: "Réessayer" }, { wait: 500 }] },
  {
    name: "réglages, rechargement",
    q: "role=pos&slow=1",
    steps: [{ wait: 10000 }, { click: '[aria-label="settings"]' }, { wait: 3000 }, { text: "Recharger le catalogue" }, { wait: 500 }],
  },
